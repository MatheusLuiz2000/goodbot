...
<html>
   <head>
      <title>The Good Bot - Criação de bot</title>
   ...
   <body>
      <div class="container">
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="well">
                  <h2 class="text-center mb-2">Criação de bots</h2>
                  <form:form modelAttribute="botModel" action="${contextPath}/bot" method="post">
                     ...
                     <button type="submit" class="btn btn-primary btn-lg">Criar novo bot</button>
                     <br>
                     <br>
                  </form:form>
               </div>
